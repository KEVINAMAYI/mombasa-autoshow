@extends('admin.layouts.dashboard',['mainpage' => 'Car of the Year','mainpagelink' => 'admin-car-for-auction','subpage' => 'Auction Cars Details']))
    ...
    <div id="container">
      ...
      <div id="page-contents">
        ...
        <div id="right-col">
          ...
          <tbody>
            <tr>
              <td colspan="2"><a href="admin-car-details/{{ $car->id }}" class="title3"><strong>{{ $car->vehicle_name }}</strong></a></td>
            </tr>
            <tr>
