...
@include('layouts.partials.navbar',['pagetitle' => 'Register'])
...
<div id="wrapper-inner">
    <div id="container">
        <div id="page-contents">
            <div id="register">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <select id="town" class="form-select @error('town') is-invalid @enderror" name="town" value="{{ old('town') }}" required>
                      <option selected>Choose...</option>
            ...
            <p style=" text-align:right; margin-top:10px;"><a href="/password/reset">Forgot Password</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/login">Login</a></p>
